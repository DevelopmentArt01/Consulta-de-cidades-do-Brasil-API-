package com.apirest.cidadesdobrasil.entities.city.service;
...
import com.apirest.cidadesdobrasil.utils.StringLocation;
...
public class DistanceService {
    ...
    public Double distanceUsingMath(final Long city1, final Long city2, final EarthRadius unit) {
        ...
        final Double[] location1 = StringLocation.transform(cities.get(0).getGeoLocation());
        final Double[] location2 = StringLocation.transform(cities.get(1).getGeoLocation());
